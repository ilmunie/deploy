...
class MACDDCAV1ControllerConfig(DirectionalTradingControllerConfigBase):
...
class MACDDCAV1Controller(DirectionalTradingControllerBase):

    def __init__(self, config: MACDDCAV1ControllerConfig, *args, **kwargs):
        self.config = config
        ...
        if len(self.config.candles_config) == 0:
            self.config.candles_config = [CandlesConfig(
                ...
                max_records=(self.config.macd_slow + self.config.macd_signal)
            )]
